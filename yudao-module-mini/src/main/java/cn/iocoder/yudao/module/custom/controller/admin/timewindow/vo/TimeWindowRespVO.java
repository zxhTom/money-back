...
@Schema(description = "管理后台 - 时间窗口 Response VO")
@Data
public class TimeWindowRespVO {
    ...
    @Schema(description = "快捷选择：1/3/7，可选", example = "1")
    private Integer quickSelect;
    @Schema(description = "按用户或按角色：user=按用户 role=按角色", example = "user")
