-- ============================================================
-- 审计日志 + 安全监控 菜单权限（Oracle 12c+）
-- 前置条件：system_menu 表中 id=108「审计日志」和 id=1「系统管理」必须存在
-- ============================================================

DECLARE
    v_audit_log_menu_id  NUMBER;
    v_security_dir_id    NUMBER;
    v_alert_menu_id      NUMBER;
    v_blacklist_menu_id  NUMBER;
BEGIN
    ...
    VALUES ('操作审计', '', 2, 3, 108, 'custom-audit-log', 'ep:notebook',
            ...
            0, '1', '0', '1', SYSTIMESTAMP, '1', SYSTIMESTAMP, '0')
